...
(constraint (=> (and (= m m_0) (= x x_0) (= x_0 1) (= m_0 1) )(inv-f m n x tmp m_0 m_1 m_2 m_3 n_0 x_0 x_1 x_2 )))
...
(constraint (=> (inv-f m n x tmp m_0 m_1 m_2 m_3 n_0 x_0 x_1 x_2 )(or (not (and (= m m_1) (= n n_0) (= x x_1) )) (not (and (not (< x_1 n_0)) (> n_0 1) (not (< m_1 n_0)) )) )))
(check-synth)
