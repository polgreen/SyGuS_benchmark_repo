...
(constraint (=> (and (= a a_0) (= j j_1) (= k k_1) (= m m_0) (<= a_0 m_0) (= j_1 0) (= k_1 0) )(inv-f a c j k m a_0 c_0 j_0 j_1 k_0 k_1 k_2 k_3 m_0 m_1 m_2 m_3 )))
...
(constraint (=> (inv-f a c j k m a_0 c_0 j_0 j_1 k_0 k_1 k_2 k_3 m_0 m_1 m_2 m_3 )(or (not (and (= a a_0) (= c c_0) (= j j_1) (= k k_2) (= m m_1) )) (not (and (not (< k_2 c_0)) (not (<= a_0 m_1)) )) )))
(check-synth)
