...
(constraint (=> (and (= conf_0 conf_0_0) (= x x_1) (= conf_0_0 8) (= x_1 0) )(inv-f conf_0 x y z conf_0_0 conf_0_1 conf_0_2 conf_0_3 conf_0_4 x_0 x_1 x_2 x_3 y_0 y_1 y_2 y_3 z_0 )))
...
(constraint (=> (inv-f conf_0 x y z conf_0_0 conf_0_1 conf_0_2 conf_0_3 conf_0_4 x_0 x_1 x_2 x_3 y_0 y_1 y_2 y_3 z_0 )(or (not (and (= conf_0 conf_0_1) (= x x_2) (= y y_1) (= z z_0) )) (not (and (not (< x_2 500)) (not (>= z_0 y_1)) )) )))
(check-synth)
