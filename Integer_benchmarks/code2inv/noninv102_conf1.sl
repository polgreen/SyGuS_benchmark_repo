...
(constraint (=> (inv-f conf_0 n x conf_0_0 conf_0_1 conf_0_2 n_0 x_0 x_1 x_2 x_3 )(or (not (and (= conf_0 conf_0_1) (= n n_0) (= x x_2) )) (not (and (not (< x_2 n_0)) (>= n_0 0) (not (= x_2 n_0)) )) )))
(check-synth)
