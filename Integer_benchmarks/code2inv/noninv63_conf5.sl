...
(constraint (=> (inv-f conf_0 conf_1 conf_2 conf_3 conf_4 x y conf_0_0 conf_0_1 conf_0_2 conf_1_0 conf_2_0 conf_3_0 conf_4_0 conf_4_1 conf_4_2 x_0 x_1 x_2 x_3 y_0 y_1 y_2 )(or (not (and (= conf_0 conf_0_1) (= conf_1 conf_1_0) (= conf_2 conf_2_0) (= conf_3 conf_3_0) (= conf_4 conf_4_1) (= x x_2) (= y y_1) )) (not (and (not (<= x_2 10)) (not (>= y_1 0)) )) )))
(check-synth)
