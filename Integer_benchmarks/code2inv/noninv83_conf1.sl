...
(constraint (=> (and (= conf_0 conf_0_0) (= x x_1) (= conf_0_0 1) (= x_1 (- 5000)) )(inv-f conf_0 x y conf_0_0 conf_0_1 conf_0_2 conf_0_3 x_0 x_1 x_2 x_3 y_0 y_1 y_2 )))
(constraint (=> (and (inv-f conf_0 x y conf_0_0 conf_0_1 conf_0_2 conf_0_3 x_0 x_1 x_2 x_3 y_0 y_1 y_2 ) (or (and (= conf_0_1 conf_0) (= x_2 x) (= y_1 y) (= conf_0_1 conf_0!) (= x_2 x!) (= y_1 y!) (= conf_0 conf_0!) (= y y!) ) (and (= conf_0_1 conf_0) (= x_2 x) (= y_1 y) (< x_2 0) (= x_3 (+ x_2 y_1 )) (= conf_0_2 (+ 133 351 )) (= y_2 (+ y_1 1 )) (= conf_0_3 (- conf_0_2 674)) (= conf_0_3 conf_0!) (= x_3 x!) (= y_2 y!) ) ) )(inv-f conf_0! x! y! conf_0_0! conf_0_1! conf_0_2! conf_0_3! x_0! x_1! x_2! x_3! y_0! y_1! y_2! )))
