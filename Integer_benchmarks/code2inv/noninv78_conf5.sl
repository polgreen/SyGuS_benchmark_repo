...
(constraint (=> (inv-f i conf_0 conf_1 conf_2 conf_3 conf_4 x y tmp i_0 i_1 i_2 i_3 i_4 conf_0_0 conf_1_0 conf_1_1 conf_1_2 conf_1_3 conf_2_0 conf_3_0 conf_4_0 x_0 y_0 )(or (not (and (= i i_2) (= conf_0 conf_0_0) (= conf_1 conf_1_1) (= conf_2 conf_2_0) (= conf_3 conf_3_0) (= conf_4 conf_4_0) (= x x_0) (= y y_0) )) (not (and (< i_2 y_0) (not (<= 0 i_2)) )) )))
(check-synth)
