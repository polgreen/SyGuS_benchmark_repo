...
(constraint (=> (and (= j j_1) (= conf_0 conf_0_0) (= k k_1) (= conf_0_0 4) (= j_1 0) (= k_1 0) )(inv-f a j conf_0 k m a_0 j_0 j_1 conf_0_0 conf_0_1 conf_0_2 conf_0_3 conf_0_4 k_0 k_1 k_2 k_3 m_0 m_1 m_2 m_3 )))
(constraint (=> (and (inv-f a j conf_0 k m a_0 j_0 j_1 conf_0_0 conf_0_1 conf_0_2 conf_0_3 conf_0_4 k_0 k_1 k_2 k_3 m_0 m_1 m_2 m_3 ) (or (and (= conf_0_1 conf_0) (= k_2 k) (= m_1 m) (= conf_0_1 conf_0!) (= k_2 k!) (= m_1 m!) (= a a!) (= j j!) (= conf_0 conf_0!) (= m m!) ) (and (= conf_0_1 conf_0) (= k_2 k) (= m_1 m) (< k_2 1) (< m_1 a_0) (= m_2 a_0) (= conf_0_2 conf_0_1) (= conf_0_3 conf_0_2) (= m_3 m_2) (= k_3 (+ k_2 1 )) (= conf_0_4 453) (= conf_0_4 conf_0!) (= k_3 k!) (= m_3 m!) (= a a_0) (= a! a_0) (= j j_1) (= j! j_1) ) (and (= conf_0_1 conf_0) (= k_2 k) (= m_1 m) (< k_2 1) (not (< m_1 a_0)) (= conf_0_3 conf_0_1) (= m_3 m_1) (= k_3 (+ k_2 1 )) (= conf_0_4 453) (= conf_0_4 conf_0!) (= k_3 k!) (= m_3 m!) (= a a_0) (= a! a_0) (= j j_1) (= j! j_1) ) ) )(inv-f a! j! conf_0! k! m! a_0! j_0! j_1! conf_0_0! conf_0_1! conf_0_2! conf_0_3! conf_0_4! k_0! k_1! k_2! k_3! m_0! m_1! m_2! m_3! )))
(constraint (=> (inv-f a j conf_0 k m a_0 j_0 j_1 conf_0_0 conf_0_1 conf_0_2 conf_0_3 conf_0_4 k_0 k_1 k_2 k_3 m_0 m_1 m_2 m_3 )(or (not (and (= a a_0) (= j j_1) (= conf_0 conf_0_1) (= k k_2) (= m m_1) )) (not (and (not (< k_2 1)) (not (<= a_0 m_1)) )) )))
(check-synth)
