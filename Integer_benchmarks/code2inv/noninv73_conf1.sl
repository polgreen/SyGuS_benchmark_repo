...
(constraint (=> (and (= c c_1) (= conf_0 conf_0_0) (= y y_0) (= z z_1) (= conf_0_0 3) (= c_1 0) (>= y_0 0) (>= y_0 127) (= z_1 (* 36 y_0)) )(inv-f c conf_0 y z tmp c_0 c_1 c_2 c_3 c_4 conf_0_0 conf_0_1 conf_0_2 conf_0_3 conf_0_4 y_0 z_0 z_1 z_2 z_3 z_4 )))
...
(constraint (=> (inv-f c conf_0 y z tmp c_0 c_1 c_2 c_3 c_4 conf_0_0 conf_0_1 conf_0_2 conf_0_3 conf_0_4 y_0 z_0 z_1 z_2 z_3 z_4 )(or (not (and (= c c_2) (= conf_0 conf_0_1) (= y y_0) (= z z_2) )) (not (and (< z_2 0) (>= z_2 4608) (not (>= c_2 36)) )) )))
(check-synth)
