...
(constraint (=> (and (= i i_1) (= j j_1) (= conf_0 conf_0_0) (= conf_0_0 0) (= i_1 1) (= j_1 10) )(inv-f i j conf_0 i_0 i_1 i_2 i_3 j_0 j_1 j_2 j_3 conf_0_0 conf_0_1 conf_0_2 conf_0_3 )))
(constraint (=> (and (inv-f i j conf_0 i_0 i_1 i_2 i_3 j_0 j_1 j_2 j_3 conf_0_0 conf_0_1 conf_0_2 conf_0_3 ) (or (and (= i_2 i) (= j_2 j) (= conf_0_1 conf_0) (= i_2 i!) (= j_2 j!) (= conf_0_1 conf_0!) (= conf_0 conf_0!) ) (and (= i_2 i) (= j_2 j) (= conf_0_1 conf_0) (>= j_2 i_2) (= i_3 (+ i_2 2 )) (= conf_0_2 (- 593 453)) (= j_3 (- j_2 1)) (= conf_0_3 973) (= i_3 i!) (= j_3 j!) (= conf_0_3 conf_0!) ) ) )(inv-f i! j! conf_0! i_0! i_1! i_2! i_3! j_0! j_1! j_2! j_3! conf_0_0! conf_0_1! conf_0_2! conf_0_3! )))
(constraint (=> (inv-f i j conf_0 i_0 i_1 i_2 i_3 j_0 j_1 j_2 j_3 conf_0_0 conf_0_1 conf_0_2 conf_0_3 )(or (not (and (= i i_2) (= j j_2) (= conf_0 conf_0_1) )) (not (and (not (>= j_2 i_2)) (not (= j_2 6)) )) )))
(check-synth)
