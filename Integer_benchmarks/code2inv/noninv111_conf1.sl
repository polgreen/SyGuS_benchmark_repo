...
(constraint (=> (inv-f i conf_0 n sn i_0 i_1 i_2 i_3 conf_0_0 conf_0_1 conf_0_2 conf_0_3 n_0 sn_0 sn_1 sn_2 sn_3 )(or (not (and (= i i_2) (= conf_0 conf_0_1) (= n n_0) (= sn sn_2) )) (not (and (not (<= i_2 n_0)) (not (= sn_2 0)) (not (= sn_2 n_0)) )) )))
(check-synth)
