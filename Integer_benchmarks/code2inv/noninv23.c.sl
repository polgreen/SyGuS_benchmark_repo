...
(constraint (=> (and (= i i_1) (= j j_1) (= i_1 1) (= j_1 20) )(inv-f i j i_0 i_1 i_2 i_3 j_0 j_1 j_2 j_3 )))
...
(constraint (=> (inv-f i j i_0 i_1 i_2 i_3 j_0 j_1 j_2 j_3 )(or (not (and (= i i_2) (= j j_2) )) (not (and (not (>= j_2 i_2)) (not (= j_2 13)) )) )))
(check-synth)
