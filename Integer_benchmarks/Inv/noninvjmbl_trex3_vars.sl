...
(constraint (=> (and (= d1 1) (and (= d2 1) (= d3 1) ) )(inv-f x1 x2 x3 d1 d2 d3 v1 v2 v3 )))
(constraint (=> (and (inv-f x1 x2 x3 d1 d2 d3 v1 v2 v3 ) (or (and (and (= x2! x2) (and (= x3! x3) (and (= d1! d1) (and (= d2! d2) (= d3! d3) ) ) ) ) (and (> x1 0) (and (> x2 0) (and (> x3 0) (= x1! (+ x1 (- 0 d1) )) ) ) ) ) (or (and (and (= x1! x1) (and (= x3! x3) (and (= d1! d1) (and (= d2! d2) (= d3! d3) ) ) ) ) (and (> x1 0) (and (> x2 0) (and (> x3 0) (= x2! (+ x2 (- 0 d2) )) ) ) ) ) (and (and (= x1! x1) (and (= x2! x2) (and (= d1! d1) (and (= d2! d2) (= d3! d3) ) ) ) ) (and (> x1 0) (and (> x2 0) (and (> x3 0) (= x3! (+ x3 (- 0 d3) )) ) ) ) ) ) ) )(inv-f x1! x2! x3! d1! d2! d3! v1! v2! v3! )))
(constraint (=> (inv-f x1 x2 x3 d1 d2 d3 v1 v2 v3 )(or (< x1 0) (or (< x2 0) (or (< x3 0) (or (= x1 0) (or (= x2 0) (= x3 0) ) ) ) ) )))
(check-synth)
