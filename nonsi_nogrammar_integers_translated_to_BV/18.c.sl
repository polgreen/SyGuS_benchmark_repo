...
(constraint (=> (inv-f m n x tmp m_0 m_1 m_2 m_3 n_0 x_0 x_1 x_2 )(or (not (and (and (= m m_1) (= n n_0) ) (= x x_1) )) (not (and (and (not (bvult x_1 n_0)) (bvugt n_0 (_ bv1 32)) ) (not (bvuge m_1 (_ bv1 32))) )) )))
(check-synth)
