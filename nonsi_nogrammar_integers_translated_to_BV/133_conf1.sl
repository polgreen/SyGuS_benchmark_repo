...
(constraint (=> (and (and (and (and (and (= conf_0 conf_0_0) (= n n_0) ) (= x x_1) ) (= conf_0_0 (_ bv9 32)) ) (= x_1 (_ bv0 32)) ) (bvuge n_0 (_ bv0 32)) )(inv-f conf_0 n x conf_0_0 conf_0_1 conf_0_2 n_0 x_0 x_1 x_2 x_3 )))
...
(constraint (=> (inv-f conf_0 n x conf_0_0 conf_0_1 conf_0_2 n_0 x_0 x_1 x_2 x_3 )(or (not (and (and (= conf_0 conf_0_1) (= n n_0) ) (= x x_2) )) (not (and (not (bvult x_2 n_0)) (not (= x_2 n_0)) )) )))
(check-synth)
