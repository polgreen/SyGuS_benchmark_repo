...
(constraint (=> (and (and (and (and (and (and (and (and (= a a_0) (= j j_0) ) (= conf_0 conf_0_0) ) (= k k_1) ) (= m m_0) ) (= conf_0_0 (_ bv4 32)) ) (bvule a_0 m_0) ) (bvult j_0 (_ bv1 32)) ) (= k_1 (_ bv0 32)) )(inv-f a j conf_0 k m a_0 j_0 conf_0_0 conf_0_1 conf_0_2 conf_0_3 conf_0_4 k_0 k_1 k_2 k_3 m_0 m_1 m_2 m_3 )))
(constraint (=> (and (inv-f a j conf_0 k m a_0 j_0 conf_0_0 conf_0_1 conf_0_2 conf_0_3 conf_0_4 k_0 k_1 k_2 k_3 m_0 m_1 m_2 m_3 ) (or (or (and (and (and (and (and (and (and (and (and (= conf_0_1 conf_0) (= k_2 k) ) (= m_1 m) ) (= conf_0_1 conf_0!) ) (= k_2 k!) ) (= m_1 m!) ) (= a a!) ) (= j j!) ) (= conf_0 conf_0!) ) (= m m!) ) (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= conf_0_1 conf_0) (= k_2 k) ) (= m_1 m) ) (bvult k_2 (_ bv1 32)) ) (bvult m_1 a_0) ) (= m_2 a_0) ) (= conf_0_2 conf_0_1) ) (= conf_0_3 conf_0_2) ) (= m_3 m_2) ) (= k_3 (bvadd k_2 (_ bv1 32))) ) (= conf_0_4 (_ bv453 32)) ) (= conf_0_4 conf_0!) ) (= k_3 k!) ) (= m_3 m!) ) (= a a_0) ) (= a! a_0) ) (= j j_0) ) (= j! j_0) ) ) (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= conf_0_1 conf_0) (= k_2 k) ) (= m_1 m) ) (bvult k_2 (_ bv1 32)) ) (not (bvult m_1 a_0)) ) (= conf_0_3 conf_0_1) ) (= m_3 m_1) ) (= k_3 (bvadd k_2 (_ bv1 32))) ) (= conf_0_4 (_ bv453 32)) ) (= conf_0_4 conf_0!) ) (= k_3 k!) ) (= m_3 m!) ) (= a a_0) ) (= a! a_0) ) (= j j_0) ) (= j! j_0) ) ) )(inv-f a! j! conf_0! k! m! a_0! j_0! conf_0_0! conf_0_1! conf_0_2! conf_0_3! conf_0_4! k_0! k_1! k_2! k_3! m_0! m_1! m_2! m_3! )))
(constraint (=> (inv-f a j conf_0 k m a_0 j_0 conf_0_0 conf_0_1 conf_0_2 conf_0_3 conf_0_4 k_0 k_1 k_2 k_3 m_0 m_1 m_2 m_3 )(or (not (and (and (and (and (= a a_0) (= j j_0) ) (= conf_0 conf_0_1) ) (= k k_2) ) (= m m_1) )) (not (and (not (bvult k_2 (_ bv1 32))) (not (bvuge a_0 m_1)) )) )))
(check-synth)
