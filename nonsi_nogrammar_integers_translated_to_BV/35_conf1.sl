...
(constraint (=> (inv-f c conf_0 tmp c_0 c_1 c_2 c_3 c_4 c_5 conf_0_0 conf_0_1 conf_0_2 conf_0_3 conf_0_4 )(or (not (and (= c c_2) (= conf_0 conf_0_1) )) (not (and (not (= c_2 (_ bv40 32))) (not (bvuge c_2 (_ bv0 32))) )) )))
(check-synth)
