...
(constraint (=> (and (and (and (and (and (and (and (= i i_1) (= j j_1) ) (= conf_0 conf_0_0) ) (= y y_1) ) (= conf_0_0 (_ bv0 32)) ) (= j_1 (_ bv0 32)) ) (= i_1 (_ bv0 32)) ) (= y_1 (_ bv2 32)) )(inv-f i j conf_0 x y i_0 i_1 i_2 i_3 j_0 j_1 j_2 j_3 conf_0_0 conf_0_1 conf_0_2 conf_0_3 x_0 y_0 y_1 )))
(constraint (=> (and (inv-f i j conf_0 x y i_0 i_1 i_2 i_3 j_0 j_1 j_2 j_3 conf_0_0 conf_0_1 conf_0_2 conf_0_3 x_0 y_0 y_1 ) (or (and (and (and (and (and (and (and (and (and (and (= i_2 i) (= j_2 j) ) (= conf_0_1 conf_0) ) (= i_2 i!) ) (= j_2 j!) ) (= conf_0_1 conf_0!) ) (= x x_0) ) (= x! x_0) ) (= j j!) ) (= conf_0 conf_0!) ) (= y y!) ) (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= i_2 i) (= j_2 j) ) (= conf_0_1 conf_0) ) (bvule i_2 x_0) ) (= i_3 (bvadd i_2 (_ bv1 32))) ) (= conf_0_2 conf_0_1) ) (= j_3 (bvadd j_2 y_1)) ) (= conf_0_3 conf_0_2) ) (= i_3 i!) ) (= j_3 j!) ) (= conf_0_3 conf_0!) ) (= x x_0) ) (= x! x_0) ) (= y y_1) ) (= y! y_1) ) ) )(inv-f i! j! conf_0! x! y! i_0! i_1! i_2! i_3! j_0! j_1! j_2! j_3! conf_0_0! conf_0_1! conf_0_2! conf_0_3! x_0! y_0! y_1! )))
