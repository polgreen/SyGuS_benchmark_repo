...
(constraint (=> (inv-f n x y n_0 x_0 x_1 x_2 y_0 y_1 y_2 )(or (not (and (and (= n n_0) (= x x_1) ) (= y y_1) )) (not (and (and (not (bvule x_1 n_0)) (bvugt n_0 (_ bv0 32)) ) (not (bvuge y_1 (_ bv0 32))) )) )))
(check-synth)
