...
(constraint (=> (and (and (and (= conf_0 conf_0_0) (= x x_1) ) (= conf_0_0 (_ bv9 32)) ) (= x_1 (_ bv0 32)) )(inv-f conf_0 x y z conf_0_0 conf_0_1 conf_0_2 conf_0_3 conf_0_4 x_0 x_1 x_2 x_3 y_0 y_1 y_2 y_3 z_0 )))
(constraint (=> (and (inv-f conf_0 x y z conf_0_0 conf_0_1 conf_0_2 conf_0_3 conf_0_4 x_0 x_1 x_2 x_3 y_0 y_1 y_2 y_3 z_0 ) (or (or (and (and (and (and (and (and (and (and (= conf_0_1 conf_0) (= x_2 x) ) (= y_1 y) ) (= conf_0_1 conf_0!) ) (= x_2 x!) ) (= y_1 y!) ) (= conf_0 conf_0!) ) (= y y!) ) (= z z!) ) (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= conf_0_1 conf_0) (= x_2 x) ) (= y_1 y) ) (bvult x_2 (_ bv5 32)) ) (= x_3 (bvadd x_2 (_ bv1 32))) ) (= conf_0_2 (bvadd (_ bv115 32) conf_0_1)) ) (bvule z_0 y_1) ) (= y_2 z_0) ) (= conf_0_3 (bvsub conf_0_2 conf_0_2)) ) (= conf_0_4 conf_0_3) ) (= y_3 y_2) ) (= conf_0_4 conf_0!) ) (= x_3 x!) ) (= y_3 y!) ) (= z z_0) ) (= z! z_0) ) ) (and (and (and (and (and (and (and (and (and (and (and (and (and (= conf_0_1 conf_0) (= x_2 x) ) (= y_1 y) ) (bvult x_2 (_ bv5 32)) ) (= x_3 (bvadd x_2 (_ bv1 32))) ) (= conf_0_2 (bvadd (_ bv115 32) conf_0_1)) ) (not (bvule z_0 y_1)) ) (= conf_0_4 conf_0_2) ) (= y_3 y_1) ) (= conf_0_4 conf_0!) ) (= x_3 x!) ) (= y_3 y!) ) (= z z_0) ) (= z! z_0) ) ) )(inv-f conf_0! x! y! z! conf_0_0! conf_0_1! conf_0_2! conf_0_3! conf_0_4! x_0! x_1! x_2! x_3! y_0! y_1! y_2! y_3! z_0! )))
(constraint (=> (inv-f conf_0 x y z conf_0_0 conf_0_1 conf_0_2 conf_0_3 conf_0_4 x_0 x_1 x_2 x_3 y_0 y_1 y_2 y_3 z_0 )(or (not (and (and (and (= conf_0 conf_0_1) (= x x_2) ) (= y y_1) ) (= z z_0) )) (not (and (not (bvult x_2 (_ bv5 32))) (not (bvuge z_0 y_1)) )) )))
(check-synth)
