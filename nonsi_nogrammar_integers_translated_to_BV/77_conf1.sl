...
(constraint (=> (inv-f i conf_0 x y tmp i_0 i_1 i_2 i_3 i_4 conf_0_0 conf_0_1 conf_0_2 conf_0_3 x_0 y_0 )(or (not (and (and (and (= i i_2) (= conf_0 conf_0_1) ) (= x x_0) ) (= y y_0) )) (not (and (bvult i_2 y_0) (not (bvult i_2 x_0)) )) )))
(check-synth)
