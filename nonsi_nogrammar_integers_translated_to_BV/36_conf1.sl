...
(constraint (=> (and (inv-f c conf_0 tmp c_0 c_1 c_2 c_3 c_4 c_5 conf_0_0 conf_0_1 conf_0_2 conf_0_3 conf_0_4 ) (or (or (or (or (and (and (and (and (and (and (= c_2 c) (= conf_0_1 conf_0) ) (= c_2 c!) ) (= conf_0_1 conf_0!) ) (= c c!) ) (= conf_0 conf_0!) ) (= tmp tmp!) ) (and (and (and (and (and (and (and (and (and (= c_2 c) (= conf_0_1 conf_0) ) (not (= c_2 (_ bv40 32))) ) (= c_3 (bvadd c_2 (_ bv1 32))) ) (= conf_0_2 (_ bv926 32)) ) (= c_4 c_3) ) (= conf_0_3 conf_0_2) ) (= c_4 c!) ) (= conf_0_3 conf_0!) ) (= tmp tmp!) ) ) (and (and (and (and (and (and (and (= c_2 c) (= conf_0_1 conf_0) ) (not (not (= c_2 (_ bv40 32)))) ) (= c_4 c_2) ) (= conf_0_3 conf_0_1) ) (= c_4 c!) ) (= conf_0_3 conf_0!) ) (= tmp tmp!) ) ) (and (and (and (and (and (and (and (and (and (= c_2 c) (= conf_0_1 conf_0) ) (= c_2 (_ bv40 32)) ) (= c_5 (_ bv1 32)) ) (= conf_0_4 (_ bv317 32)) ) (= c_4 c_5) ) (= conf_0_3 conf_0_4) ) (= c_4 c!) ) (= conf_0_3 conf_0!) ) (= tmp tmp!) ) ) (and (and (and (and (and (and (and (= c_2 c) (= conf_0_1 conf_0) ) (not (= c_2 (_ bv40 32))) ) (= c_4 c_2) ) (= conf_0_3 conf_0_1) ) (= c_4 c!) ) (= conf_0_3 conf_0!) ) (= tmp tmp!) ) ) )(inv-f c! conf_0! tmp! c_0! c_1! c_2! c_3! c_4! c_5! conf_0_0! conf_0_1! conf_0_2! conf_0_3! conf_0_4! )))
(constraint (=> (inv-f c conf_0 tmp c_0 c_1 c_2 c_3 c_4 c_5 conf_0_0 conf_0_1 conf_0_2 conf_0_3 conf_0_4 )(or (not (and (= c c_2) (= conf_0 conf_0_1) )) (not (and (not (= c_2 (_ bv40 32))) (not (bvule c_2 (_ bv40 32))) )) )))
(check-synth)
