...
(constraint (=> (and (inv-f c tmp c_0 c_1 c_2 c_3 c_4 c_5 ) (or (or (or (or (and (and (and (= c_2 c) (= c_2 c!) ) (= c c!) ) (= tmp tmp!) ) (and (and (and (and (and (= c_2 c) (not (= c_2 (_ bv40 32))) ) (= c_3 (bvadd c_2 (_ bv1 32))) ) (= c_4 c_3) ) (= c_4 c!) ) (= tmp tmp!) ) ) (and (and (and (and (= c_2 c) (not (not (= c_2 (_ bv40 32)))) ) (= c_4 c_2) ) (= c_4 c!) ) (= tmp tmp!) ) ) (and (and (and (and (and (= c_2 c) (= c_2 (_ bv40 32)) ) (= c_5 (_ bv1 32)) ) (= c_4 c_5) ) (= c_4 c!) ) (= tmp tmp!) ) ) (and (and (and (and (= c_2 c) (not (= c_2 (_ bv40 32))) ) (= c_4 c_2) ) (= c_4 c!) ) (= tmp tmp!) ) ) )(inv-f c! tmp! c_0! c_1! c_2! c_3! c_4! c_5! )))
(constraint (=> (inv-f c tmp c_0 c_1 c_2 c_3 c_4 c_5 )(or (not (= c c_2)) (not (and (and (bvult c_2 (_ bv0 32)) (bvugt c_2 (_ bv40 32)) ) (not (= c_2 (_ bv40 32))) )) )))
(check-synth)
