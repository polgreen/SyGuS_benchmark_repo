...
(constraint (=> (inv-f i x y tmp i_0 i_1 i_2 i_3 i_4 x_0 y_0 )(or (not (and (and (= i i_2) (= x x_0) ) (= y y_0) )) (not (and (and (bvuge i_2 x_0) (bvugt (_ bv0 32) i_2) ) (not (bvuge i_2 y_0)) )) )))
(check-synth)
