...
(constraint (=> (inv-f d1 d2 d3 x1 x2 x3 d1_0 d2_0 d3_0 x1_0 x1_1 x1_2 x1_3 x2_0 x2_1 x2_2 x2_3 x3_0 x3_1 x3_2 x3_3 )(or (not (and (and (and (and (and (= d1 d1_0) (= d2 d2_0) ) (= d3 d3_0) ) (= x1 x1_1) ) (= x2 x2_1) ) (= x3 x3_1) )) (not (and (not (bvugt x1_1 (_ bv0 32))) (not (bvuge x2_1 (_ bv0 32))) )) )))
(check-synth)
