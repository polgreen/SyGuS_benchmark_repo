...
(constraint (=> (and (and (and (= conf_0 conf_0_0) (= x x_1) ) (= conf_0_0 (_ bv9 32)) ) (= x_1 (_ bv1 32)) )(inv-f conf_0 n x y conf_0_0 conf_0_1 conf_0_2 conf_0_3 n_0 x_0 x_1 x_2 x_3 y_0 y_1 y_2 )))
(constraint (=> (and (inv-f conf_0 n x y conf_0_0 conf_0_1 conf_0_2 conf_0_3 n_0 x_0 x_1 x_2 x_3 y_0 y_1 y_2 ) (or (and (and (and (and (and (and (and (and (and (= conf_0_1 conf_0) (= x_2 x) ) (= y_1 y) ) (= conf_0_1 conf_0!) ) (= x_2 x!) ) (= y_1 y!) ) (= n n_0) ) (= n! n_0) ) (= conf_0 conf_0!) ) (= y y!) ) (and (and (and (and (and (and (and (and (and (and (and (and (= conf_0_1 conf_0) (= x_2 x) ) (= y_1 y) ) (bvule x_2 n_0) ) (= y_2 (bvsub n_0 x_2)) ) (= conf_0_2 (_ bv329 32)) ) (= x_3 (bvadd x_2 (_ bv1 32))) ) (= conf_0_3 (bvadd conf_0_2 (_ bv522 32))) ) (= conf_0_3 conf_0!) ) (= x_3 x!) ) (= y_2 y!) ) (= n n_0) ) (= n! n_0) ) ) )(inv-f conf_0! n! x! y! conf_0_0! conf_0_1! conf_0_2! conf_0_3! n_0! x_0! x_1! x_2! x_3! y_0! y_1! y_2! )))
(constraint (=> (inv-f conf_0 n x y conf_0_0 conf_0_1 conf_0_2 conf_0_3 n_0 x_0 x_1 x_2 x_3 y_0 y_1 y_2 )(or (not (and (and (and (= conf_0 conf_0_1) (= n n_0) ) (= x x_2) ) (= y y_1) )) (not (and (and (not (bvule x_2 n_0)) (bvugt n_0 (_ bv0 32)) ) (not (bvuge y_1 (_ bv0 32))) )) )))
(check-synth)
