...
(constraint (=> (and (inv-f c n tmp c_0 c_1 c_2 c_3 c_4 c_5 n_0 ) (or (or (or (or (and (and (and (and (= c_2 c) (= c_2 c!) ) (= c c!) ) (= n n!) ) (= tmp tmp!) ) (and (and (and (and (and (and (and (= c_2 c) (bvugt c_2 n_0) ) (= c_3 (bvadd c_2 (_ bv1 32))) ) (= c_4 c_3) ) (= c_4 c!) ) (= n n_0) ) (= n! n_0) ) (= tmp tmp!) ) ) (and (and (and (and (and (and (= c_2 c) (not (bvugt c_2 n_0)) ) (= c_4 c_2) ) (= c_4 c!) ) (= n n_0) ) (= n! n_0) ) (= tmp tmp!) ) ) (and (and (and (and (and (and (and (= c_2 c) (= c_2 n_0) ) (= c_5 (_ bv1 32)) ) (= c_4 c_5) ) (= c_4 c!) ) (= n n_0) ) (= n! n_0) ) (= tmp tmp!) ) ) (and (and (and (and (and (and (= c_2 c) (not (= c_2 n_0)) ) (= c_4 c_2) ) (= c_4 c!) ) (= n n_0) ) (= n! n_0) ) (= tmp tmp!) ) ) )(inv-f c! n! tmp! c_0! c_1! c_2! c_3! c_4! c_5! n_0! )))
(constraint (=> (inv-f c n tmp c_0 c_1 c_2 c_3 c_4 c_5 n_0 )(or (not (and (= c c_2) (= n n_0) )) (not (and (not (= c_2 n_0)) (not (bvuge c_2 (_ bv0 32))) )) )))
(check-synth)
