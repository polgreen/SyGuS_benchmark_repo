...
(constraint (=> (inv-f c conf_0 y z tmp c_0 c_1 c_2 c_3 c_4 conf_0_0 conf_0_1 conf_0_2 conf_0_3 conf_0_4 y_0 z_0 z_1 z_2 z_3 z_4 )(or (not (and (and (and (= c c_2) (= conf_0 conf_0_1) ) (= y y_0) ) (= z z_2) )) (not (and (bvult c_2 (_ bv36 32)) (not (bvuge z_2 (_ bv0 32))) )) )))
(check-synth)
