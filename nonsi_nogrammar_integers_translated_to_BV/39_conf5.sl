...
(constraint (=> (and (and (and (and (and (and (and (and (and (and (and (and (and (= c c_1) (= conf_0 conf_0_0) ) (= conf_1 conf_1_0) ) (= conf_2 conf_2_0) ) (= conf_3 conf_3_0) ) (= conf_4 conf_4_0) ) (= n n_0) ) (= conf_0_0 (_ bv3 32)) ) (= conf_1_0 (_ bv0 32)) ) (= conf_2_0 (_ bv7 32)) ) (= conf_3_0 (_ bv5 32)) ) (= conf_4_0 (_ bv0 32)) ) (= c_1 (_ bv0 32)) ) (bvugt n_0 (_ bv0 32)) )(inv-f c conf_0 conf_1 conf_2 conf_3 conf_4 n tmp c_0 c_1 c_2 c_3 c_4 c_5 conf_0_0 conf_1_0 conf_2_0 conf_3_0 conf_3_1 conf_3_2 conf_3_3 conf_4_0 conf_4_1 conf_4_2 conf_4_3 n_0 )))
(constraint (=> (and (inv-f c conf_0 conf_1 conf_2 conf_3 conf_4 n tmp c_0 c_1 c_2 c_3 c_4 c_5 conf_0_0 conf_1_0 conf_2_0 conf_3_0 conf_3_1 conf_3_2 conf_3_3 conf_4_0 conf_4_1 conf_4_2 conf_4_3 n_0 ) (or (or (and (and (and (and (and (and (and (and (and (and (and (and (and (= c_2 c) (= conf_3_1 conf_3) ) (= conf_4_1 conf_4) ) (= c_2 c!) ) (= conf_3_1 conf_3!) ) (= conf_4_1 conf_4!) ) (= c c!) ) (= conf_0 conf_0!) ) (= conf_1 conf_1!) ) (= conf_2 conf_2!) ) (= conf_3 conf_3!) ) (= conf_4 conf_4!) ) (= n n!) ) (= tmp tmp!) ) (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= c_2 c) (= conf_3_1 conf_3) ) (= conf_4_1 conf_4) ) (= c_2 n_0) ) (= c_3 (_ bv1 32)) ) (= conf_3_2 (bvadd conf_4_1 (_ bv965 32))) ) (= c_4 c_3) ) (= conf_3_3 conf_3_2) ) (= conf_4_2 conf_4_1) ) (= c_4 c!) ) (= conf_3_3 conf_3!) ) (= conf_4_2 conf_4!) ) (= conf_0 conf_0_0) ) (= conf_0! conf_0_0) ) (= conf_1 conf_1_0) ) (= conf_1! conf_1_0) ) (= conf_2 conf_2_0) ) (= conf_2! conf_2_0) ) (= n n_0) ) (= n! n_0) ) (= tmp tmp!) ) ) (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= c_2 c) (= conf_3_1 conf_3) ) (= conf_4_1 conf_4) ) (not (= c_2 n_0)) ) (= c_5 (bvadd c_2 (_ bv1 32))) ) (= conf_4_3 conf_2_0) ) (= c_4 c_5) ) (= conf_3_3 conf_3_1) ) (= conf_4_2 conf_4_3) ) (= c_4 c!) ) (= conf_3_3 conf_3!) ) (= conf_4_2 conf_4!) ) (= conf_0 conf_0_0) ) (= conf_0! conf_0_0) ) (= conf_1 conf_1_0) ) (= conf_1! conf_1_0) ) (= conf_2 conf_2_0) ) (= conf_2! conf_2_0) ) (= n n_0) ) (= n! n_0) ) (= tmp tmp!) ) ) )(inv-f c! conf_0! conf_1! conf_2! conf_3! conf_4! n! tmp! c_0! c_1! c_2! c_3! c_4! c_5! conf_0_0! conf_1_0! conf_2_0! conf_3_0! conf_3_1! conf_3_2! conf_3_3! conf_4_0! conf_4_1! conf_4_2! conf_4_3! n_0! )))
(constraint (=> (inv-f c conf_0 conf_1 conf_2 conf_3 conf_4 n tmp c_0 c_1 c_2 c_3 c_4 c_5 conf_0_0 conf_1_0 conf_2_0 conf_3_0 conf_3_1 conf_3_2 conf_3_3 conf_4_0 conf_4_1 conf_4_2 conf_4_3 n_0 )(or (not (and (and (and (and (and (and (= c c_2) (= conf_0 conf_0_0) ) (= conf_1 conf_1_0) ) (= conf_2 conf_2_0) ) (= conf_3 conf_3_1) ) (= conf_4 conf_4_1) ) (= n n_0) )) (not (and (= c_2 n_0) (not (bvule c_2 n_0)) )) )))
(check-synth)
