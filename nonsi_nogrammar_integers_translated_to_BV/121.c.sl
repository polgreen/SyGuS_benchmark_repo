...
(constraint (=> (inv-f i sn i_0 i_1 i_2 i_3 sn_0 sn_1 sn_2 sn_3 )(or (not (and (= i i_2) (= sn sn_2) )) (not (and (and (not (bvule i_2 (_ bv8 32))) (not (= sn_2 (_ bv0 32))) ) (not (= sn_2 (_ bv8 32))) )) )))
(check-synth)
