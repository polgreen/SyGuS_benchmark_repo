...
(constraint (=> (inv-f i conf_0 conf_1 conf_2 conf_3 conf_4 n sn i_0 i_1 i_2 i_3 conf_0_0 conf_1_0 conf_2_0 conf_2_1 conf_2_2 conf_3_0 conf_4_0 conf_4_1 conf_4_2 n_0 sn_0 sn_1 sn_2 sn_3 )(or (not (and (and (and (and (and (and (and (= i i_2) (= conf_0 conf_0_0) ) (= conf_1 conf_1_0) ) (= conf_2 conf_2_1) ) (= conf_3 conf_3_0) ) (= conf_4 conf_4_1) ) (= n n_0) ) (= sn sn_2) )) (not (and (and (not (bvule i_2 n_0)) (not (= sn_2 (_ bv0 32))) ) (not (= sn_2 n_0)) )) )))
(check-synth)
