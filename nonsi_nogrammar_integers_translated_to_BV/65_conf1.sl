...
(constraint (=> (and (inv-f conf_0 x y conf_0_0 conf_0_1 conf_0_2 conf_0_3 x_0 x_1 x_2 x_3 y_0 y_1 y_2 ) (or (and (and (and (and (and (and (and (= conf_0_1 conf_0) (= x_2 x) ) (= y_1 y) ) (= conf_0_1 conf_0!) ) (= x_2 x!) ) (= y_1 y!) ) (= conf_0 conf_0!) ) (= y y!) ) (and (and (and (and (and (and (and (and (and (and (= conf_0_1 conf_0) (= x_2 x) ) (= y_1 y) ) (bvule x_2 (_ bv100 32)) ) (= y_2 (bvsub (_ bv100 32) x_2)) ) (= conf_0_2 (bvsub (_ bv469 32) conf_0_1)) ) (= x_3 (bvadd x_2 (_ bv1 32))) ) (= conf_0_3 (bvadd (_ bv687 32) (_ bv622 32))) ) (= conf_0_3 conf_0!) ) (= x_3 x!) ) (= y_2 y!) ) ) )(inv-f conf_0! x! y! conf_0_0! conf_0_1! conf_0_2! conf_0_3! x_0! x_1! x_2! x_3! y_0! y_1! y_2! )))
(constraint (=> (inv-f conf_0 x y conf_0_0 conf_0_1 conf_0_2 conf_0_3 x_0 x_1 x_2 x_3 y_0 y_1 y_2 )(or (not (and (and (= conf_0 conf_0_1) (= x x_2) ) (= y y_1) )) (not (and (not (bvule x_2 (_ bv100 32))) (not (bvuge y_1 (_ bv0 32))) )) )))
(check-synth)
