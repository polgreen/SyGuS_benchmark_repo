...
(constraint (=> (and (inv-f x y ) (or (and (= (mod) (_ bv0 32)) (and (= x! (bvadd x (_ bv20 32))) (and (= y! y) (bvult x (_ bv99 32)) ) ) ) (and (= x! (bvsub (_ bv5 32) x)) (and (= y! y) (bvult x (_ bv99 32)) ) ) ) )(inv-f x! y! )))
