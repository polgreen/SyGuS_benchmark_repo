...
(constraint (=> (inv-f c y z tmp c_0 c_1 c_2 c_3 c_4 y_0 z_0 z_1 z_2 z_3 z_4 )(or (not (and (and (= c c_2) (= y y_0) ) (= z z_2) )) (not (and (bvult c_2 (_ bv36 32)) (not (bvult z_2 (_ bv4608 32))) )) )))
(check-synth)
