...
(constraint (=> (inv-f i j conf_0 x y i_0 i_1 j_0 j_1 conf_0_0 conf_0_1 conf_0_2 conf_0_3 x_0 x_1 x_2 y_0 y_1 y_2 )(or (not (and (and (and (and (= i i_1) (= j j_1) ) (= conf_0 conf_0_1) ) (= x x_1) ) (= y y_1) )) (not (and (and (not (not (= x_1 (_ bv0 32)))) (= i_1 j_1) ) (not (= y_1 (_ bv0 32))) )) )))
(check-synth)
