...
(constraint (=> (and (and (and (= i i_1) (= sn sn_1) ) (= sn_1 (_ bv0 32)) ) (= i_1 (_ bv1 32)) )(inv-f i size sn i_0 i_1 i_2 i_3 size_0 sn_0 sn_1 sn_2 sn_3 )))
(constraint (=> (and (inv-f i size sn i_0 i_1 i_2 i_3 size_0 sn_0 sn_1 sn_2 sn_3 ) (or (and (and (and (and (and (and (= i_2 i) (= sn_2 sn) ) (= i_2 i!) ) (= sn_2 sn!) ) (= size size_0) ) (= size! size_0) ) (= sn sn!) ) (and (and (and (and (and (and (and (and (= i_2 i) (= sn_2 sn) ) (bvule i_2 size_0) ) (= i_3 (bvadd i_2 (_ bv1 32))) ) (= sn_3 (bvadd sn_2 (_ bv1 32))) ) (= i_3 i!) ) (= sn_3 sn!) ) (= size size_0) ) (= size! size_0) ) ) )(inv-f i! size! sn! i_0! i_1! i_2! i_3! size_0! sn_0! sn_1! sn_2! sn_3! )))
(constraint (=> (inv-f i size sn i_0 i_1 i_2 i_3 size_0 sn_0 sn_1 sn_2 sn_3 )(or (not (and (and (= i i_2) (= size size_0) ) (= sn sn_2) )) (not (and (and (not (bvule i_2 size_0)) (not (= sn_2 (_ bv0 32))) ) (not (= sn_2 size_0)) )) )))
(check-synth)
