...
(constraint (=> (inv-f i n sn i_0 i_1 i_2 i_3 n_0 sn_0 sn_1 sn_2 sn_3 )(or (not (and (and (= i i_2) (= n n_0) ) (= sn sn_2) )) (not (and (and (not (bvule i_2 n_0)) (not (= sn_2 n_0)) ) (not (= sn_2 (_ bv0 32))) )) )))
(check-synth)
