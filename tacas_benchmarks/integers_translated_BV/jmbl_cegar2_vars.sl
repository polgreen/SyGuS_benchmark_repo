...
(constraint (=> (and (= x (_ bv0 32)) (= m (_ bv0 32)) )(inv-f x n m z1 z2 z3 )))
...
(constraint (=> (inv-f x n m z1 z2 z3 )(not (and (and (bvuge x n) (bvugt n (_ bv0 32)) ) (or (bvule n m) (bvult m (_ bv0 32)) ) ))))
(check-synth)
