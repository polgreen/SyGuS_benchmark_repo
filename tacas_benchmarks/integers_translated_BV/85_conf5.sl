...
(constraint (=> (and (and (and (and (and (and (and (and (and (and (and (= conf_0 conf_0_0) (= conf_1 conf_1_0) ) (= conf_2 conf_2_0) ) (= conf_3 conf_3_0) ) (= conf_4 conf_4_0) ) (= x x_1) ) (= conf_0_0 (_ bv9 32)) ) (= conf_1_0 (_ bv0 32)) ) (= conf_2_0 (_ bv7 32)) ) (= conf_3_0 (_ bv0 32)) ) (= conf_4_0 (_ bv3 32)) ) (= x_1 (_ bv4294952296 32)) )(inv-f conf_0 conf_1 conf_2 conf_3 conf_4 x y conf_0_0 conf_1_0 conf_1_1 conf_1_2 conf_2_0 conf_2_1 conf_2_2 conf_3_0 conf_4_0 x_0 x_1 x_2 x_3 y_0 y_1 y_2 )))
(constraint (=> (and (inv-f conf_0 conf_1 conf_2 conf_3 conf_4 x y conf_0_0 conf_1_0 conf_1_1 conf_1_2 conf_2_0 conf_2_1 conf_2_2 conf_3_0 conf_4_0 x_0 x_1 x_2 x_3 y_0 y_1 y_2 ) (or (and (and (and (and (and (and (and (and (and (and (and (and (and (= conf_1_1 conf_1) (= conf_2_1 conf_2) ) (= x_2 x) ) (= y_1 y) ) (= conf_1_1 conf_1!) ) (= conf_2_1 conf_2!) ) (= x_2 x!) ) (= y_1 y!) ) (= conf_0 conf_0!) ) (= conf_1 conf_1!) ) (= conf_2 conf_2!) ) (= conf_3 conf_3!) ) (= conf_4 conf_4!) ) (= y y!) ) (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= conf_1_1 conf_1) (= conf_2_1 conf_2) ) (= x_2 x) ) (= y_1 y) ) (bvslt x_2 (_ bv0 32)) ) (= x_3 (bvadd x_2 y_1)) ) (= conf_1_2 (bvadd (_ bv286 32) conf_3_0)) ) (= y_2 (bvadd y_1 (_ bv1 32))) ) (= conf_2_2 (bvadd conf_0_0 conf_0_0)) ) (= conf_1_2 conf_1!) ) (= conf_2_2 conf_2!) ) (= x_3 x!) ) (= y_2 y!) ) (= conf_0 conf_0_0) ) (= conf_0! conf_0_0) ) (= conf_3 conf_3_0) ) (= conf_3! conf_3_0) ) (= conf_4 conf_4_0) ) (= conf_4! conf_4_0) ) ) )(inv-f conf_0! conf_1! conf_2! conf_3! conf_4! x! y! conf_0_0! conf_1_0! conf_1_1! conf_1_2! conf_2_0! conf_2_1! conf_2_2! conf_3_0! conf_4_0! x_0! x_1! x_2! x_3! y_0! y_1! y_2! )))
(constraint (=> (inv-f conf_0 conf_1 conf_2 conf_3 conf_4 x y conf_0_0 conf_1_0 conf_1_1 conf_1_2 conf_2_0 conf_2_1 conf_2_2 conf_3_0 conf_4_0 x_0 x_1 x_2 x_3 y_0 y_1 y_2 )(or (not (and (and (and (and (and (and (= conf_0 conf_0_0) (= conf_1 conf_1_1) ) (= conf_2 conf_2_1) ) (= conf_3 conf_3_0) ) (= conf_4 conf_4_0) ) (= x x_2) ) (= y y_1) )) (not (and (not (bvslt x_2 (_ bv0 32))) (not (bvsgt y_1 (_ bv0 32))) )) )))
(check-synth)
