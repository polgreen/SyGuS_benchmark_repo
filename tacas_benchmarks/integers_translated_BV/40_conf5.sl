...
(constraint (=> (inv-f c conf_0 conf_1 conf_2 conf_3 conf_4 n tmp c_0 c_1 c_2 c_3 c_4 c_5 conf_0_0 conf_1_0 conf_1_1 conf_1_2 conf_1_3 conf_2_0 conf_2_1 conf_2_2 conf_2_3 conf_3_0 conf_4_0 n_0 )(or (not (and (and (and (and (and (and (= c c_2) (= conf_0 conf_0_0) ) (= conf_1 conf_1_1) ) (= conf_2 conf_2_1) ) (= conf_3 conf_3_0) ) (= conf_4 conf_4_0) ) (= n n_0) )) (not (and (not (= c_2 n_0)) (not (bvuge c_2 (_ bv0 32))) )) )))
(check-synth)
