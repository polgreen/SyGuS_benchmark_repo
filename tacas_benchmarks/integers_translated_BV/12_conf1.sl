...
(constraint (=> (and (and (and (and (and (and (and (= conf_0 conf_0_0) (= x x_0) ) (= y y_0) ) (= conf_0_0 (_ bv1 32)) ) (bvuge x_0 (_ bv0 32)) ) (bvule x_0 (_ bv10 32)) ) (bvule y_0 (_ bv10 32)) ) (bvuge y_0 (_ bv0 32)) )(inv-f conf_0 x y tmp conf_0_0 conf_0_1 conf_0_2 conf_0_3 x_0 x_1 x_2 y_0 y_1 y_2 )))
(constraint (=> (and (inv-f conf_0 x y tmp conf_0_0 conf_0_1 conf_0_2 conf_0_3 x_0 x_1 x_2 y_0 y_1 y_2 ) (or (and (and (and (and (and (and (and (and (and (= conf_0_1 conf_0) (= x_1 x) ) (= y_1 y) ) (= conf_0_1 conf_0!) ) (= x_1 x!) ) (= y_1 y!) ) (= conf_0 conf_0!) ) (= x x!) ) (= y y!) ) (= tmp tmp!) ) (and (and (and (and (and (and (and (and (and (and (= conf_0_1 conf_0) (= x_1 x) ) (= y_1 y) ) (= x_2 (bvadd x_1 (_ bv10 32))) ) (= conf_0_2 conf_0_1) ) (= y_2 (bvadd y_1 (_ bv10 32))) ) (= conf_0_3 (bvadd conf_0_2 conf_0_2)) ) (= conf_0_3 conf_0!) ) (= x_2 x!) ) (= y_2 y!) ) (= tmp tmp!) ) ) )(inv-f conf_0! x! y! tmp! conf_0_0! conf_0_1! conf_0_2! conf_0_3! x_0! x_1! x_2! y_0! y_1! y_2! )))
(constraint (=> (inv-f conf_0 x y tmp conf_0_0 conf_0_1 conf_0_2 conf_0_3 x_0 x_1 x_2 y_0 y_1 y_2 )(or (not (and (and (= conf_0 conf_0_1) (= x x_1) ) (= y y_1) )) (not (and (= y_1 (_ bv0 32)) (not (not (= x_1 (_ bv20 32)))) )) )))
(check-synth)
