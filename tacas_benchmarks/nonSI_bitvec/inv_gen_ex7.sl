...
(constraint 
(=> (or3 (bvult x #x00000000) (bvult y #x00000000) (bvugt y x)) true)
)

(constraint 
(=> (and3 (not (or3 (bvult x #x00000000) (bvult y #x00000000) (bvugt y x))) (= l x) (= i #x00000000)) (inv i y l))
)

(constraint 
(=> (and4 (inv i y l) (bvult i y) (not (or (bvult i #x00000000) (bvuge i l))) (= i1 (bvadd i #x00000001))) (inv i1 y l))
)

(constraint 
(=> (and3 (inv i y l) (bvult i y) (or (bvult i #x00000000) (bvuge i l))) false)
)
