...
(constraint 
(=> (and5 (inv i l) (=> (= l #x00000004) (= l1 #x00000000)) (=> (not (= l #x00000004)) (= l1 l)) (not (or (bvult l1 #x00000000) (bvuge l1 #x00000005))) (= l2 (bvadd l1 #x00000001))) (inv i l2))
)

(constraint 
(=> (and4 (inv i l) (=> (= l #x00000004) (= l1 #x00000000)) (=> (not (= l #x00000004)) (= l1 l)) (or (bvult l1 #x00000000) (bvuge l1 #x00000005))) false)
)
