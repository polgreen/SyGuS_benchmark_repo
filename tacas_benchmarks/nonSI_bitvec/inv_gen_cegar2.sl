...
(constraint 
(=> (and (= x #x00000000) (= m #x00000000)) (inv x m n))
)

(constraint 
(=> (and5 (inv x m n) (bvult x n) (or (= m1 x) (= m1 m)) (= x1 ( bvadd x #x00000001)) (= n1 n)) (inv x1 m1 n1))
)

(constraint 
(=> (and3 (inv x m n) (bvuge x n) (bvugt n #x00000000)) (and (bvule #x00000000 m) (bvult m n)))
)
