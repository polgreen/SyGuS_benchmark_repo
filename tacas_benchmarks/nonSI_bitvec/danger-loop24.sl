...
(constraint 
(=> (and (D i c a) (G i)) (and (bvugt (R i c a) #x00000000) (and (bvugt (R i c a) (R (B_i i) (B_c i c) a)) (D (B_i i) (B_c i c) a))))
)

(constraint 
(=> (and (D i c a) (not (G i))) (not (A a)))
)

(constraint 
(D #x00000000 #x00000000 (a0 i c a))
)
