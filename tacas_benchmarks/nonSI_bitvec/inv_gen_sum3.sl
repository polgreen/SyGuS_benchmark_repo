...
(constraint 
(=> (and (= s #x00000000) (= x #x00000000)) (inv s l n x))
)

(constraint 
(=> (and3 (inv s l n x) (= s1 (bvadd s #x00000001)) (= x1 (bvadd x #x00000001))) (or (= s1 x1) (= s1 #x00000000)))
)

(constraint 
(=> (and3 (inv s l n x) (= s1 (bvadd s #x00000001)) (= x1 (bvadd x #x00000001))) (inv s1 l n x1))
)
